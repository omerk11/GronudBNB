...
namespace GroundBNB.Services
{
    ...
    {
        public static string APIkeycon = "gBj09V3viDBCvBx2CN9CTX36R";

        public static string APIsecretKeycon = "qpurOawIzvtjPsM9psCuNKMq5GCMuKTfiuxEQqWxuPu3AoOIfh";

        public static string BearerToken = "AAAAAAAAAAAAAAAAAAAAAHoQUgEAAAAAGPKuK%2FEegJ%2FSaZ5AAAt1sLkH%2B3o%3DgTFFEGUOvTQuqp7vMTwbdoyxKeo0PCsMRDVmd8Fwtjy3LHcbBO";

        public static string AccessToken = "1446754631535714307-KpLlt6crhJiwj0nY7k9dEW44ytikKM";

        public static string AccessTokenSecret = "nMI8aNpfAKMjTjSB9h7TmU8xXrnim7Bte6XqkagyFU61q";
        private string aPIsecretKeycon;
        ...
        /// </summary>
        readonly string _TwitterImageAPI = "https://upload.twitter.com/1.1/media/upload.json";

        /// <summary>
        /// Current tweet limit
        /// </summary>
        readonly int _limit = 280;
